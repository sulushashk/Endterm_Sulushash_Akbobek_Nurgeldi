...
import com.company.repositories.BookInfoRepo;
import com.company.repositories.LibrarianRepo;
import com.company.repositories.LibraryRepo;
import com.company.repositories.ReaderRepo;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        IBookInfoRepo repo1 = new BookInfoRepo(db) {
            IBookRepo repo2 = new BookRepo(db);
